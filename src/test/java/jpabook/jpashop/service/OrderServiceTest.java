...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("기본JPA", 10000, 10);
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("기본JPA",10000,10);

        int orderCount = 11;

        //when
        orderService.order(member.getId(), item.getId(), orderCount); //에러발생 해야함

        //then
        fail("여기로 넘어오면 안됩니다, 재고 수량 부족 예외가 발생해야합니다.");
    }
